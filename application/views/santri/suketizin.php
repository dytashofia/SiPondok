...
<table>
	...
	foreach($izin as $row)
	{
		?>
				<tr>
				<td >
				<font>Nama Santri    : <?php echo $row->nama_santri; ?></font><br><br>
				<font>Nama Wali      : <?php echo $row->nama_wali; ?></font><br><br>
				<font>Alamat Santri  : <?php echo $row->alamat; ?></font> <br><br>
				</td>
				</tr>
