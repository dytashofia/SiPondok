                 ...
                 <div class="col-xl-9 col-lg-6 col-md-12">
                     <div class="card" style="margin-bottom:-11px;">
                         <div class="card-header " style="background: linear-gradient(to right, #00cef9, #00e6af);">
                             <ul class="list-inline kl ">
                                 <li><i class=" ft-bar-chart-2 rr"></i></li>
                                 <li class="tb">
                                     <h4 class="pp  text-center">KOMPETENSI</h4>
                                 </li>
                                 </span>
                             </ul>
                     ...
                     <div class="card ">
                         ...
                         <div class="card-content collapse show">
                             <div class="card-body">
                                 <div>
                                     &nbsp;&nbsp;&nbsp;<a href="#"><button type="button" class="btn btn-primary btn-min-width mr-1 ff mb-1"><i class="ft-plus"> </i> Tambah Data</button></a>
                                 </div>
