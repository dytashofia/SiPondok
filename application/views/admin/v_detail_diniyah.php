    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Detail Data Diniyah</h3>
            </div>
                ...
                <div class="breadcrumbs-top float-md-right">
                    <div class="breadcrumb-wrapper mr-1">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Detail Data Diniyah
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Detail Data Diniyah</h4>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-body">
                                            ...
                                            <fieldset class="form-group">
                                                <input type="text" name="nama_mapel" id="nama_mapel" value="<?= $diniyah->nama_mapel; ?>" class="form-control" readonly>
                                            </fieldset>

                                            <h5 class="mt-2">Tanggal Diniyah</h5>
                                            <fieldset class="form-group">
                                                <input type="date" name="tgl_diniyah" id="tgl_diniyah" value="<?= $diniyah->tgl_diniyah; ?>" class="form-control" readonly>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
