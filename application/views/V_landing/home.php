...
<head>
  ...
  <title>PP Raden Rahmat Sunan Ampel</title>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-12">
          ...
          <h1>DI WEBSITE PONDOK PESANTREN</h1>
          <h1>RADEN RAHMAT SUNAN AMPEL JEMBER</h1>
          <a href="https://www.youtube.com/watch?v=FXZHG1Hk9XM" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="produk" class="portfolio">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-web">Mukennah</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="assets/img/produk/mukenah/g2.jpeg" class="img-fluid" alt="">
            <div class="portfolio-info">
