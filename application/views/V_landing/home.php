...
<head>
  ...
  <title>PONPES RADEN RAHMAD SUNAN AMPEL JEMBER</title>
  <!--
...
-->
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/landing/css/templatemo-klassy-cafe.css">

  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/landing/css/owl-carousel.css">

  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/landing/css/lightbox.css">
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="<?php echo base_url(); ?>assets/landing/images/klassy-logo.png" align="klassy cafe html template">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
        ...
        <div class="col-lg-6 col-md-6 col-xs-12">
          <div class="left-text-content">
            ...
            <div class="row">
              ...
              <div class="col-4">
                <img src="<?php echo base_url(); ?>assets/landing/images/about-thumb-02.jpg" alt="">
              </div>
              <div class="col-4">
  ...
  <script src="<?php echo base_url(); ?>assets/landing/js/accordions.js"></script>
  <script src="<?php echo base_url(); ?>assets/landing/js/datepicker.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/landing/js/slick.js"></script>
  <script src="<?php echo base_url(); ?>assets/landing/js/lightbox.js"></script>
